...
const ContactContent = dynamic(() => import("@/content/contact.mdx"));
...
export default async function ContactPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12 flex justify-center">
            <div className="max-w-6xl w-full bg-background border rounded-xl shadow-xl p-8 md:p-12 relative overflow-hidden">
